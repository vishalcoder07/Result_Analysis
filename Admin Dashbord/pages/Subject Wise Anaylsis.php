      ...
      <div class="row">
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Subject Wise Anaylsis</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="container">
          
          <form action="./show subject wise anaylsis.php" method="POST">
                <div class="row">
                  <div class="col-lg-4">
          ...
          <div class="col-lg-4">
             ...
             <select required class="form-select" id="subject" name="subject" >
